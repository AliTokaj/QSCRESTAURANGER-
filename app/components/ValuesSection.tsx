...
const sponsors = [
  "Sponsring Surahammar A-lag,Sirius bandy",
  "Sponsring Hallstahammars HK Herr",
  "Sponsring Hallstahammars HK Dam",
  ...
  "Sigtuna Basketklubb , Östersunds fotbollsklubb",
  "Östersunds IK, Warpen Hockey",
  "FBC Bollnäs",
  "Bollnäs GIF Bandy",
  "AIK Hockey skyltplats (Härnösand) ,Örebro Elithockey",
  "ÖSK Fotboll",
  "KIF Damfotboll",
  "Örebro Tennisklubb",
  "Örebro City Golf",
