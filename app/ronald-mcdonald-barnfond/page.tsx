...
// ✅ Strongly type fadeIn as Variants
const fadeIn = (direction: "left" | "right" = "left"): Variants => {
  return {
    hidden: {
      opacity: 0,
...
const Page = () => {
  const supportOptions = [
    {
      ...
      description:
        "Regelbundna gåvor ger oss möjlighet att planera långsiktigt och säkerställa kontinuitet i vår verksamhet.",
    ...
    },
    {
      ...
      description:
        "Att skapa en insamling är ett fint sätt att engagera sig. Till att underlätta vardagen för fler familjer med svårt sjuka barn.",
    ...
    },
    {
      ...
      description:
        "Varje gåva är värdefull. Du kan enkelt bidra med en valfri summa som gör skillnad för familjer med sjuka barn.",
      buttonText: "Donera",
  ...
  return (
    <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mt-4">
                Ronald McDonald <span className="text-[#f9d00f]">Hus</span>
              </h2>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mt-6">
                <div className="border-l-4 border-[#f9d00f] pl-4">
                  <a
                    href="https://www.ronaldmcdonaldhus.se/"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <img
                      src="RMBarnfond_logo.png"
                      alt="insamlingskontroll_logga"
                ...
                <div className="border-l-4 border-[#f9d00f] pl-4">
                  ...
                  >
                    <img
                      src="insamlingskontroll_logga.svg"
                      alt="RMBarnfond_logo"
      ...
      {/* Vad & Vart är Ronald McDonald Hus Section */}
      <section className="mt-50">
      ...
      <section className="bg-[#FBF7F7] py-12 px-4 mt-50">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="text-lg text-gray-600 mt-2">
            Det finns många sätt att bidra och varje insats gör skillnad för
